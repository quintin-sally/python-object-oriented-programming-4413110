...
class Book:
    ...
    def __lt__(self, value): # THIS ALLOWS YOU TO SORT THE OBJECTS / COMPARED TO ONE ANOTHER
        if not isinstance(value, Book):
            raise ValueError("Cannot compare Book to non-Book")
        return self.price < value.price
...
print(b1 == b3) #compares two objects against each other and sees they're different in memory
print(b1 == b2)
#print(b1 == "A Memory of Light")
